# Contributing to hubEvals

This outlines how to propose a change to `hubEvals`. For more general
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("hubverse-org/hubEvals", fork = TRUE)`.
...
Please note that the hubEvals project is released with a [Contributor
Code of
