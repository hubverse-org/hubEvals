...
#'
#' @param proj_dat Projection (outcome) data; proj_dat must include columns: target_end_date, forecast_date, quantile, value, type, location_name, location, and age_group
...
dat_for_scores_func <- function(proj_dat, obs_data){

  require(tidyr)

  all_dat = drop_na(proj_dat)
